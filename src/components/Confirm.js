    ...
    return (
        ...
        <div className="w-full h-full flex flex-col justify-center items-center bg-white">
            <div className="flex flex-col items-left justify-center w-full no-scrollbar overflow-y-auto">
                <div className="mx-auto w-3/4 h-1/4 flex flex-col justify-end">
                    <text className="font-Raleway block text-gray-700 text-3xl font-bold">Information Summary</text>
                </div>   

                <div className="w-3/4 h-screen flex flex-col justify-center mx-auto">
                    <div className="border-b-2 border-black  flex flex-col overflow-hidden">   
                        <text className="">Full Name: {personalData.fullName}</text>
                    ...
                    <div className="flex flex-col overflow-hidden">
                        ...
                        <text className="">References: {workExData.Refs}</text>
                    </div>
                </div>            

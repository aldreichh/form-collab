    ...
    return (
        <>
            <div className="w-96 h-3/4 flex flex-col justify-center items-center mx-auto bg-white rounded-2xl drop-shadow-xl">
                <form className="flex flex-col items-left justify-center w-full h-full no-scrollbar overflow-y-auto" onSubmit={handleFormSubmit}>
                    <text className="block text-gray-700 text-2xl font-bold mb-8 text-center">Personal Information</text>
                    ...
                    <div className="w-3/4 mx-auto flex justify-between mt-7">
